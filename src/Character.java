...
public class Character {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (!randomizeAll.isSelected()) {//there was a tick box in the first window that allowed the user to choose if they wanted to select stuff. If they wanted to, this happens:
            ...
            String[] classChoices = {"", "Barbarian", "Bard", "Cleric", "Druid", "Fighter", "Monk", "Rogue", "Paladin"};//another popup to choose their class
        ...
        while (!(classAssessment.matches("Fighter|Rogue|Barbarian|Bard|Cleric|Druid|Monk|Paladin")))
        ...
        switch (classAssessment.toUpperCase())//if it fits one of these, it creates that class and creates the first level.
        {
            ...
            case "CLERIC":
                ...
                break;
            case "BARD":
                Bard bard = new Bard(stats, userAncestry);
                bard.createFirstLevel();
                break;
            case "DRUID":
                Druid druid = new Druid(stats, userAncestry);
                druid.createFirstLevel();
                break;
            case "MONK":
                Monk monk = new Monk(stats, userAncestry);
                monk.createFirstLevel();
                break;
            case "PALADIN":
                Paladin paladin = new Paladin(stats, userAncestry);
                paladin.createFirstLevel();
                break;
        }
